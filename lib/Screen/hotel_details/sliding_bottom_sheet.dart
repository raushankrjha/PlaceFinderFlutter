...
import 'package:flutter_app/Screen/hotel_details/sliding_bottom_sheet_content.dart';
...
class SlidingBottomSheet extends StatefulWidget {
  ...
  SlidingBottomSheet({this.controller, this.cornerRadius,this.getsingleCatItem,this.getplaceimages});
              ...
              child: Scaffold(
                ...
                body: AnimatedContainer(
                  ...
                  child: Stack(children: <Widget>[
                    ...
                    BottomSheetContent(controller: bottomSheetController,getsingleCatItem: widget.getsingleCatItem,getplaceimages: widget.getplaceimages,)
                  ]),
                ),
              ),
            ),
